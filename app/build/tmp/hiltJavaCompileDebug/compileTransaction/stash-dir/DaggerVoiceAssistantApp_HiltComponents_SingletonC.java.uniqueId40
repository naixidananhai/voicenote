...
import com.voicelife.assistant.di.AppModule;
import com.voicelife.assistant.di.AppModule_ProvideContextFactory;
import com.voicelife.assistant.di.DatabaseModule;
import com.voicelife.assistant.di.DatabaseModule_ProvideAppDatabaseFactory;
import com.voicelife.assistant.di.DatabaseModule_ProvideRecordingDaoFactory;
import com.voicelife.assistant.di.DatabaseModule_ProvideTranscriptionDaoFactory;
...
public final class DaggerVoiceAssistantApp_HiltComponents_SingletonC {
  private DaggerVoiceAssistantApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public VoiceAssistantApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements VoiceAssistantApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl(singletonCImpl);
    }
  }

  private static final class ActivityCBuilder implements VoiceAssistantApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements VoiceAssistantApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements VoiceAssistantApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements VoiceAssistantApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements VoiceAssistantApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements VoiceAssistantApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public VoiceAssistantApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends VoiceAssistantApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends VoiceAssistantApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends VoiceAssistantApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends VoiceAssistantApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends VoiceAssistantApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityRetainedCImpl extends VoiceAssistantApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends VoiceAssistantApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public void injectVoiceMonitorService(VoiceMonitorService voiceMonitorService) {
      injectVoiceMonitorService2(voiceMonitorService);
    }

    @CanIgnoreReturnValue
    private VoiceMonitorService injectVoiceMonitorService2(VoiceMonitorService instance) {
      VoiceMonitorService_MembersInjector.injectNotificationHelper(instance, singletonCImpl.notificationHelperProvider.get());
  ...
  private static final class SingletonCImpl extends VoiceAssistantApp_HiltComponents.SingletonC {
    ...
    private RecordingDao recordingDao() {
      return DatabaseModule_ProvideRecordingDaoFactory.provideRecordingDao(provideAppDatabaseProvider.get());
    }

    private TranscriptionDao transcriptionDao() {
      return DatabaseModule_ProvideTranscriptionDaoFactory.provideTranscriptionDao(provideAppDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.recordingRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<RecordingRepository>(singletonCImpl, 2));
    ...
    @Override
    public void injectVoiceAssistantApp(VoiceAssistantApp voiceAssistantApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.voicelife.assistant.utils.PermissionManager 
          ...
          case 2: // com.voicelife.assistant.data.repository.RecordingRepository 
          return (T) new RecordingRepository(singletonCImpl.recordingDao(), singletonCImpl.transcriptionDao());

          case 3: // com.voicelife.assistant.data.database.AppDatabase 
          return (T) DatabaseModule_ProvideAppDatabaseFactory.provideAppDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 4: // com.voicelife.assistant.storage.StorageManager 
          return (T) new StorageManager(singletonCImpl.provideContextProvider.get(), singletonCImpl.recordingRepositoryProvider.get());

          case 5: // com.voicelife.assistant.utils.DebugLogger 
